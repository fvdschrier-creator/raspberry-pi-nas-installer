...
alleen al is 631MB). Download onderstaande bestanden zelf en zet ze in
deze map, VOORDAT je Beheer_install.bat draait.

De actuele downloadlinks staan ook in Gedeeld\download_links.ini.

| Bestand | Waarvoor | Download |
|---|---|---|
| Docker Desktop Installer.exe | NAS-simulator | https://desktop.docker.com/win/main/amd64/Docker%20Desktop%20Installer.exe |
...
(python-3*.exe, putty*.msi, tigervnc*.exe, Docker*.exe) - dat is wat
